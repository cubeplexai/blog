...
[OpenSandbox](https://github.com/opensandbox-group/OpenSandbox) 最初由阿里开源，早期仓库位于 `alibaba/OpenSandbox`，目前代码已迁移到独立的 `opensandbox-group` 组织。Java、JavaScript、.NET 和 Go 的包名仍保留 Alibaba 标识。项目提供多语言 SDK、CLI 和 MCP Server，运行环境可以部署在 Docker 或 Kubernetes 上。
...
[CubeSandbox](https://github.com/TencentCloud/CubeSandbox) 是腾讯云开源的 Sandbox 平台。项目包含 CubeAPI、CubeMaster、Cubelet、CubeShim、CubeHypervisor、网络和存储组件，Sandbox 运行在 KVM MicroVM 中。
