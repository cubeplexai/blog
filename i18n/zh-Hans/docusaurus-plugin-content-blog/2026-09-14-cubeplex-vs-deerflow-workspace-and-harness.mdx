...
DeerFlow 2.0 和 CubePlex 都是通用 Agent 环境。它们都支持长期记忆、Skills、MCP、Sandbox、Sub-agent 和即时通讯入口，也都允许用户在一个对话窗口里完成研究、写作、编程和文件处理，而不是先为每个场景制作一款独立 App。
...
- DeerFlow 2.0 基于 `main` 提交 [`14c9d44440780e63563e935046db8708e121a5b1`](https://github.com/bytedance/deer-flow/commit/14c9d44440780e63563e935046db8708e121a5b1)，核对范围包括 [README 中的产品定位](https://github.com/bytedance/deer-flow/blob/14c9d44440780e63563e935046db8708e121a5b1/README.md#from-deep-research-to-super-agent-harness)、[Projects](https://github.com/bytedance/deer-flow/blob/14c9d44440780e63563e935046db8708e121a5b1/backend/packages/harness/deerflow/persistence/projects/sql.py)、[用户级 Skill Storage](https://github.com/bytedance/deer-flow/blob/14c9d44440780e63563e935046db8708e121a5b1/backend/packages/harness/deerflow/skills/storage/user_scoped_skill_storage.py)、[Sandbox 生命周期](https://github.com/bytedance/deer-flow/blob/14c9d44440780e63563e935046db8708e121a5b1/backend/packages/harness/deerflow/sandbox/middleware.py)、[Sandbox 网络策略](https://github.com/bytedance/deer-flow/blob/14c9d44440780e63563e935046db8708e121a5b1/backend/docs/CONFIGURATION.md#sandbox-network-policy)、[请求级密钥](https://github.com/bytedance/deer-flow/blob/14c9d44440780e63563e935046db8708e121a5b1/backend/packages/harness/deerflow/sandbox/env_policy.py) 与 [MCP 配置](https://github.com/bytedance/deer-flow/blob/14c9d44440780e63563e935046db8708e121a5b1/backend/packages/harness/deerflow/config/extensions_config.py)。DeerFlow 2.0 与 1.x Deep Research 不共享代码，本文只讨论 2.0。
- CubePlex 基于提交 `d5b0f03ac04e62762b1918f4c4ee3ee4df2e315c` 核对 Organization / Workspace 成员关系、AgentConfig、[CubeLoop Runtime 接入](https://github.com/cubeplexai/cubeplex/blob/d5b0f03ac04e62762b1918f4c4ee3ee4df2e315c/backend/cubeplex/streams/run_manager.py)、[Skill 安装与绑定](https://github.com/cubeplexai/cubeplex/blob/d5b0f03ac04e62762b1918f4c4ee3ee4df2e315c/backend/cubeplex/models/skill.py)、[MCP 四层数据模型](https://github.com/cubeplexai/cubeplex/blob/d5b0f03ac04e62762b1918f4c4ee3ee4df2e315c/backend/cubeplex/models/mcp.py)、[Sandbox 分层环境变量](https://github.com/cubeplexai/cubeplex/blob/d5b0f03ac04e62762b1918f4c4ee3ee4df2e315c/backend/cubeplex/models/sandbox_env.py)、[出口密钥替换](https://github.com/cubeplexai/cubeplex/blob/d5b0f03ac04e62762b1918f4c4ee3ee4df2e315c/backend/cubeplex/services/egress_exchange.py)、分层 Memory、Sandbox Scope 和命令审批策略。CubePlex 当前使用 CubeLoop `v0.14.1`。
