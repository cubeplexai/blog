...
DeerFlow 2.0 and CubePlex are both general-purpose agent environments. Both support long-term memory, Skills, MCP, Sandboxes, Sub-agents, and messaging integrations. Both let users research, write, code, and work with files from one conversation instead of building a separate App for every use case.
...
- DeerFlow 2.0 was reviewed at `main` commit [`14c9d44440780e63563e935046db8708e121a5b1`](https://github.com/bytedance/deer-flow/commit/14c9d44440780e63563e935046db8708e121a5b1), including the [product overview](https://github.com/bytedance/deer-flow/blob/14c9d44440780e63563e935046db8708e121a5b1/README.md#from-deep-research-to-super-agent-harness), [Projects](https://github.com/bytedance/deer-flow/blob/14c9d44440780e63563e935046db8708e121a5b1/backend/packages/harness/deerflow/persistence/projects/sql.py), [user-scoped Skill storage](https://github.com/bytedance/deer-flow/blob/14c9d44440780e63563e935046db8708e121a5b1/backend/packages/harness/deerflow/skills/storage/user_scoped_skill_storage.py), [Sandbox lifecycle](https://github.com/bytedance/deer-flow/blob/14c9d44440780e63563e935046db8708e121a5b1/backend/packages/harness/deerflow/sandbox/middleware.py), [Sandbox network policy](https://github.com/bytedance/deer-flow/blob/14c9d44440780e63563e935046db8708e121a5b1/backend/docs/CONFIGURATION.md#sandbox-network-policy), [request-scoped secrets](https://github.com/bytedance/deer-flow/blob/14c9d44440780e63563e935046db8708e121a5b1/backend/packages/harness/deerflow/sandbox/env_policy.py), and [MCP configuration](https://github.com/bytedance/deer-flow/blob/14c9d44440780e63563e935046db8708e121a5b1/backend/packages/harness/deerflow/config/extensions_config.py). DeerFlow 2.0 shares no code with the 1.x Deep Research codebase; this comparison covers 2.0.
- CubePlex was reviewed at commit `d5b0f03ac04e62762b1918f4c4ee3ee4df2e315c`, covering Organization and Workspace membership, AgentConfig, [CubeLoop Runtime integration](https://github.com/cubeplexai/cubeplex/blob/d5b0f03ac04e62762b1918f4c4ee3ee4df2e315c/backend/cubeplex/streams/run_manager.py), [Skill installation and binding](https://github.com/cubeplexai/cubeplex/blob/d5b0f03ac04e62762b1918f4c4ee3ee4df2e315c/backend/cubeplex/models/skill.py), the [four-layer MCP data model](https://github.com/cubeplexai/cubeplex/blob/d5b0f03ac04e62762b1918f4c4ee3ee4df2e315c/backend/cubeplex/models/mcp.py), [layered Sandbox environment variables](https://github.com/cubeplexai/cubeplex/blob/d5b0f03ac04e62762b1918f4c4ee3ee4df2e315c/backend/cubeplex/models/sandbox_env.py), [egress secret substitution](https://github.com/cubeplexai/cubeplex/blob/d5b0f03ac04e62762b1918f4c4ee3ee4df2e315c/backend/cubeplex/services/egress_exchange.py), layered Memory, Sandbox Scope, and command approval policy. CubePlex currently uses CubeLoop `v0.14.1`.
