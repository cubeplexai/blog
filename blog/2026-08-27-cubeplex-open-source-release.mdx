...
description: CubePlex is an enterprise agent platform for team workspaces, with managed agents, governed access, isolated sandboxes, and Docker Compose and Kubernetes deployment assets.
authors: [xfgong]
...
CubePlex is now open source. The backend, web application, deployment assets, and product documentation are available on [GitHub](https://github.com/cubeplexai/cubeplex).
